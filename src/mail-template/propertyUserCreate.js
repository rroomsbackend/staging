export default (propertyName, email, password, firstName, lastName, role, designation) => `
    <!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    ...
    <table width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color: #ffffff; width: 700px; margin:auto">
        ...
        <tr>
            <td style="padding: 20px; text-align: center; background-color: #5cb85c; color: #ffffff;">
                <h1 style="margin: 0; font-size: 28px;">Welcome to ${propertyName}!</h1>
                <p style="margin: 5px 0 15px; font-size: 18px;">Dear ${firstName + " " + lastName},</p>
        ...
        <tr>
            <td style="padding: 20px; background-color: #fff4e5;">
                ...
                <p><strong>Temporary Password:</strong> ${password} (Please update this in your profile settings)</p>
                <p><strong>Login Link:</strong> <a href="https://rrooms.in/register" style="color: #ff8c00; text-decoration: none;">Click here to log in</a></p>
            </td>
        </tr>
        <tr>
